...
namespace Valve.VR
{
    ...
    /// </summary>
    public class SteamVRActionVector3 : SteamVRActionIn<SteamVRActionVector3SourceMap, SteamVRActionVector3Source>, ISteamVRActionVector3
    {
        public delegate void AxisHandler(SteamVRActionVector3 fromAction, SteamVRInputSources fromSource, Vector3 axis, Vector3 delta);
        public delegate void ActiveChangeHandler(SteamVRActionVector3 fromAction, SteamVRInputSources fromSource, bool active);
        public delegate void ChangeHandler(SteamVRActionVector3 fromAction, SteamVRInputSources fromSource, Vector3 axis, Vector3 delta);
        public delegate void UpdateHandler(SteamVRActionVector3 fromAction, SteamVRInputSources fromSource, Vector3 axis, Vector3 delta);
        ...
        public Vector3 axis { get { return sourceMap[SteamVRInputSources.Any].axis; } }

        /// <summary><strong>[Shortcut to: SteamVR_Input_Sources.Any]</strong> The Vector3 value of the action from the previous update.
        /// Note: Will only return non-zero if the action is also active.</summary>
        public Vector3 lastAxis { get { return sourceMap[SteamVRInputSources.Any].lastAxis; } }
        ...
        /// Note: Will only return non-zero if the action is also active.</summary>
        public Vector3 delta { get { return sourceMap[SteamVRInputSources.Any].delta; } }
        ...
        /// Note: Will only return non-zero if the action is also active.</summary>
        public Vector3 lastDelta { get { return sourceMap[SteamVRInputSources.Any].lastDelta; } }

        public SteamVRActionVector3() { }

        /// <summary>The current Vector3 value of the action</summary>
        /// <param name="inputSource">The device you would like to get data from. Any if the action is not device specific.</param>
        public Vector3 GetAxis(SteamVRInputSources inputSource)
        {
        ...
        /// <param name="inputSource">The device you would like to get data from. Any if the action is not device specific.</param>
        public Vector3 GetAxisDelta(SteamVRInputSources inputSource)
        {
        ...
        /// <param name="inputSource">The device you would like to get data from. Any if the action is not device specific.</param>
        public Vector3 GetLastAxis(SteamVRInputSources inputSource)
        {
        ...
        /// <param name="inputSource">The device you would like to get data from. Any if the action is not device specific.</param>
        public Vector3 GetLastAxisDelta(SteamVRInputSources inputSource)
        {
    ...
    public class SteamVRActionVector3SourceMap : SteamVRActionInSourceMap<SteamVRActionVector3Source>
    {
    }

    public class SteamVRActionVector3Source : SteamVRActionInSource, ISteamVRActionVector3
    {
        ...
        protected SteamVRActionVector3 vector3Action;
        ...
        public override void Preinitialize(SteamVRAction wrappingAction, SteamVRInputSources forInputSource)
        {
            ...
            vector3Action = (SteamVRActionVector3)wrappingAction;
        }
        ...
        public void RemoveAllListeners()
        {
            ...
            if (onAxis != null)
            {
                ...
                if (delegates != null)
                {
                    ...
                    {
                        onAxis -= (SteamVRActionVector3.AxisHandler)existingDelegate;
                    }
                }
            }
            ...
            if (onUpdate != null)
            {
                ...
                if (delegates != null)
                {
                    foreach (Delegate existingDelegate in delegates)
                    {
                        onUpdate -= (SteamVRActionVector3.UpdateHandler)existingDelegate;
                    }
                }
            }
            ...
            if (onChange != null)
            {
                ...
                if (delegates != null)
                {
                    foreach (Delegate existingDelegate in delegates)
                    {
                        onChange -= (SteamVRActionVector3.ChangeHandler)existingDelegate;
                    }
                }
            }
            ...
            if (onActiveChange != null)
            {
                ...
                if (delegates != null)
                {
                    foreach (Delegate existingDelegate in delegates)
                    {
                        onActiveChange -= (SteamVRActionVector3.ActiveChangeHandler)existingDelegate;
                    }
                }
            }
            ...
            if (onActiveBindingChange != null)
            {
                ...
                if (delegates != null)
                {
                    foreach (Delegate existingDelegate in delegates)
                    {
                        onActiveBindingChange -= (SteamVRActionVector3.ActiveChangeHandler)existingDelegate;
                    }
                }
            }
        }
    ...
    /// </summary>
    public interface ISteamVRActionVector3 : ISteamVRActionInSource
    {
