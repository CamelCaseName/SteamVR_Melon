...
namespace SteamVR_Melon.Scripts
{

#pragma warning disable SYSLIB0021 // Type or member is obsolete
    public static class SteamVRUtils
    {
        public class Event
        {
            ...
            {
                if (listeners[message] is Handler actions)
                {
            ...
            private static readonly Hashtable listeners = new();
        }
        ...
        public struct RigidTransform
        {
            ...
            public RigidTransform(HmdMatrix34T pose)
            {
            ...
            public RigidTransform(HmdMatrix44T pose)
            {
                var m = Matrix4x4.identity;
            ...
            public readonly HmdMatrix44T ToHmdMatrix44()
            {
                var m = Matrix4x4.TRS(pos, rot, Vector3.one);
                var pose = new HmdMatrix44T
                {
                    m0 = m[0, 0],
                    m1 = m[0, 1],
                    m2 = -m[0, 2],
            ...
            public readonly HmdMatrix34T ToHmdMatrix34()
            {
                var m = Matrix4x4.TRS(pos, rot, Vector3.one);
                var pose = new HmdMatrix34T
                {
                    m0 = m[0, 0],
                    m1 = m[0, 1],
                    m2 = -m[0, 2],
            ...
            public readonly RigidTransform GetInverse()
            {
        ...
        public static object CallSystemFn(SystemFn fn, params object[] args)
        {
            ...
            if (initOpenVR)
            {
                ...
                OpenVR.Init(ref error, EVRApplicationType.VRApplicationUtility);
            }
        ...
        public static void TakeStereoScreenshot(uint screenshotHandle, GameObject target, int cellSize, float ipd, ref string previewFilename, ref string VRFilename)
        {
            ...
            var fx = camera.gameObject.AddComponent<SteamVRSphericalProjection>();
            ...
            timer.Stop();
            MelonLoader.MelonLogger.Msg(string.Format("Screenshot took {0} seconds.", timer.Elapsed));
