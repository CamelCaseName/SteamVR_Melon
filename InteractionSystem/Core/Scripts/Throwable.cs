...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Throwable : MonoBehaviour
    {
        ...
        /// <summary>The local point which acts as a positional and rotational offset to use while held</summary>
        public Transform attachmentOffset;

        ///<summary>How fast must this object be moving to attach due to a trigger hold instead of a trigger press? (-1 to disable)</summary>
        public float catchingSpeedThreshold = -1;

        public ReleaseStyle releaseVelocityStyle = ReleaseStyle.GetFromHand;

        /// <summary>The time offset used when releasing the object with the RawFromHand option</summary>
        public float releaseVelocityTimeOffset = -0.011f;

        public float scaleReleaseVelocity = 1.1f;

        /// <summary>The release velocity magnitude representing the end of the scale release velocity curve. (-1 to disable)</summary>
        public float scaleReleaseVelocityThreshold = -1.0f;
        /// <summary>Use this curve to ease into the scaled release velocity based on the magnitude of the measured release velocity. This allows greater differentiation between a drop, toss, and throw.</summary>
        ...
        public virtual void GetReleaseVelocities(Hand hand, out Vector3 velocity, out Vector3 angularVelocity)
        {
            ...
            switch (releaseVelocityStyle)
            {
                case ReleaseStyle.ShortEstimation:
                    ...
                    {
                        MelonLoader.MelonLogger.Warning("[SteamVR Interaction System] Throwable: No Velocity Estimator component on object but release style set to short estimation. Please add one or change the release style.");
