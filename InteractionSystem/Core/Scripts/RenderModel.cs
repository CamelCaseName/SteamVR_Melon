    ...
    public class RenderModel : MonoBehaviour
    {
        ...
        protected void InitializeHand()
        {
            if (handPrefab != null)
            {
                ...
                {
                    MelonLoader.MelonLogger.Warning("Skeleton action: " + handSkeleton.skeletonAction.GetPath() + " is not bound. Your controller may not support SteamVR Skeleton Input. " +
