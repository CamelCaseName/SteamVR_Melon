...
namespace Valve.VR.InteractionSystem
{
    ...
    {
        public Arrow(IntPtr value) : base(value) { }

        private const int DefaultPhysicsLayer = -5;
        ...
        public void ArrowReleased(float inputVelocity)
        {
            ...
            RaycastHit[] hits = Physics.SphereCastAll(transform.position, 0.01f, transform.forward, 0.80f, DefaultPhysicsLayer, QueryTriggerInteraction.Ignore);
