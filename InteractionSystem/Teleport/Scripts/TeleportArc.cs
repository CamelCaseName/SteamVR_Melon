...
namespace Valve.VR.InteractionSystem
{
    ...
    {
        public TeleportArc(IntPtr value) : base(value) { }
        public int segmentCount = 60;
        public float thickness = 0.01f;

        /// <summary>The amount of time in seconds to predict the motion of the projectile.</summary>
        public float arcDuration = 3.0f;

        /// <summary>The amount of time in seconds between each segment of the projectile.</summary>
        public float segmentBreak = 0.025f;

        /// <summary>The speed at which the line segments of the arc move.</summary>
