...
namespace Valve.VR.InteractionSystem
{
    ...
    {
        public TeleportPoint(IntPtr va) : base(va) { }
        ...
        public void TeleportToScene()
        {
            ...
            {
                MelonLoader.MelonLogger.Msg("[HPVR Interaction] TeleportPoint: Hook up your level loading logic to switch to new scene: " + switchToScene, this);
            }
            else
            {
                MelonLoader.MelonLogger.Error("[HPVR Interaction] TeleportPoint: Invalid scene name to switch to: " + switchToScene, this);
            }
        }
