...
namespace Valve.VR.InteractionSystem.Sample
{
    ...
    {
        public BuggyBuddy(IntPtr value) : base(value) { }   

        public Transform turret;
        float turretRot;


        /// <summary>Maximum steering angle of the wheels</summary>
        public float maxAngle = 30f;
        /// <summary>Maximum Turning torque</summary>
        public float maxTurnTorque = 30f;
        /// <summary>Maximum torque applied to the driving wheels</summary>
        public float maxTorque = 300f;
        /// <summary>Maximum brake torque applied to the driving wheels</summary>
        public float brakeTorque = 30000f;
        /// <summary>If you need the visual wheels to be attached automatically, drag the wheel shape here.</summary>
        public GameObject[] wheelRenders;

        /// <summary>The vehicle's speed when the physics engine can use different amount of sub-steps (in m/s).</summary>
        public float criticalSpeed = 5f;
        /// <summary>Simulation sub-steps when the speed is above critical.</summary>
        public int stepsBelow = 5;
        /// <summary>Simulation sub-steps when the speed is below critical.</summary>
