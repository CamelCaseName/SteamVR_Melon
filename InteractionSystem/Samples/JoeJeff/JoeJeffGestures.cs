...
namespace Valve.VR.InteractionSystem.Sample
{
    ...
    {
        public JoeJeffGestures(IntPtr value) : base(value) { }
        ...
        private void Update()
        {
            ...
            for (int handIndex = 0; handIndex < Player.instance.hands.Length; handIndex++)
            {
                if (Player.instance.hands[handIndex] != null)
                {
                    ...
                    if (skeleton != null)
                    {
                        //MelonLoader.MelonLogger.Msg("{0:0.00}, {1:0.00}, {2:0.00}, {3:0.00}, {4:0.00}", skeleton.thumbCurl, skeleton.indexCurl, skeleton.middleCurl, skeleton.ringCurl, skeleton.pinkyCurl);
