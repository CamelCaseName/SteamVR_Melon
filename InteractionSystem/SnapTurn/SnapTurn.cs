...
namespace Valve.VR.InteractionSystem
{
    ...
    {
        public SnapTurn(System.IntPtr value) : base(value) { }
        ...
        public void RotatePlayer(float angle)
        {
            ...
            {
                MelonLoader.MelonCoroutines.Stop(rotateCoroutine);
                AllOff();
            }

            rotateCoroutine = DoRotatePlayer(angle);
            MelonLoader.MelonCoroutines.Start(rotateCoroutine);
        }
